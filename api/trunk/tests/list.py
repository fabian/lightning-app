...
class DeviceListsTests(Tests):
    ...
    def test_get_lists(self):
        ...
        self.assertEqual(response.body, '{"lists": [{"count": 0, "title": "List A", "url": "http://localhost:80/api/lists/3", "token": "xzy", "unread": false, "id": 3}, {"count": 0, "title": "List B", "url": "http://localhost:80/api/lists/5", "token": "xzy", "unread": false, "id": 5}]}')
